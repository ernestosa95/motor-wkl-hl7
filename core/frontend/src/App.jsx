...
export default function App() {
  ...
  // Si el login indica que hay que cambiar la contraseña, se activa esta pantalla.
  const [debeCambiar, setDebeCambiar] = useState(
    localStorage.getItem('debe_cambiar_password') === 'true'
  );
  ...
  // Callback que recibe el Login: token ya guardado + flag de cambio obligatorio
  const alLoguear = (debe_cambiar_password) => {
    setDebeCambiar(!!debe_cambiar_password);
    setLogueado(true);
  };

  if (!logueado) return <Login onLogin={alLoguear} />;
